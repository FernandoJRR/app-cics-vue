...
<template>
  ...
  <v-card max-width="60%" min-height="60%">
    <v-card-title>
      Clases
    </v-card-title>
    <iframe :src="clasesPDF" style="min-height: 55vh; min-width: 100%; border: none"/>
    <v-card-actions>
    2 de Febrero, 12:00 PM
    </v-card-actions>
  </v-card>
  ...
  <v-card max-width="60%" min-height="60%">
    ...
    <iframe :src="labsPDF" style="min-height: 63vh; min-width: 100%; border: none"/>
    <v-card-actions>
    2 de Febrero, 12:00 PM
    </v-card-actions>
  </v-card>
